...
from config import AWS_ACCESS_KEY, AWS_SECRET_KEY, SNS_REGION
...
def send_msg_to_phone(msg, phone_number):
    logging.basicConfig(level=logging.INFO, format='%(levelname)s: %(message)s')

    sns_wrapper = SnsWrapper(boto3.resource('sns', region_name=SNS_REGION,
    ...
    if phone_number != '':
        sns_wrapper.publish_text_message(phone_number, msg)
